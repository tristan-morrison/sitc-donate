...
td[class="pattern"] .c600p100n { width: 100%;}
td[class="pattern"] .c183p33r { width: 33.27272727272727%;}
td[class="pattern"] .c366p66r { width: 66.72727272727272%;}
...
only screen and (max-device-width: 400px) {
 ...
 .hide { display:none !important; width:0px !important;height:0px !important; overflow:hidden; }
	.c600p100n { width: 100% !important;}
.c183p33r { width: 100% !important; float:none;}
.c366p66r { width: 100% !important; float:none;}

}
</style>
<style>
@media only screen and (min-width: 600px) {
  td[class="pattern"] .c600p100n { width: 100% !important;}
td[class="pattern"] .c183p33r { width: 183px !important;}
td[class="pattern"] .c366p66r { width: 366px !important;}
...
only screen and (max-device-width: 400px) {
  ...
  td[class="pattern"] .c600p100n { width: 100% !important; }
td[class="pattern"] .c183p33r { width: 100% !important; }
td[class="pattern"] .c366p66r { width: 100% !important; }
...
.img138x100 { width: 138px !important; height: 100px !important;}
.img163x163 { width: 163px !important; height: 163px !important;}
.img325x325 { width: 325px !important; height: 325px !important;}
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="font-family:Arial, sans-serif; font-size:0px;margin:0;padding:0;background: #FFFFFFF !important;" bgcolor="#FFFFFFF">
<!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]--><!--[if t]><![endif]-->
  <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%"  bgcolor="#FFFFFFF" style="margin:0; padding:0; width:100% !important; background: #FFFFFFF !important;">
    <tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#F0EAD6"  style="background-color:#F0EAD6"><tr><td valign="top"  style="padding:0px"><table cellpadding="0" cellspacing="0" width="600" align="center"  style="max-width:600px;min-width:240px;margin:0 auto" class="email-root-wrapper"><tr><td valign="top"  style="padding:0px"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td valign="top"  style="padding:10px"><div  style="text-align:left;font-family:Verdana, Geneva, sans-serif;font-size:12px;color:#343148;line-height:22px;mso-line-height:exactly;mso-text-raise:5px"><p style="padding: 0; margin: 0;text-align: center;"><strong>Summer in the City. All rights reserved.</strong></p><p
style="padding: 0; margin: 0;text-align: center;">1655 Clark Street</p><p style="padding: 0; margin: 0;text-align: center;">Detroit, MI 48209</p><p style="padding: 0; margin: 0;text-align: center;">248.790.1000</p></div></td>
</tr>
</table>
</td>
</tr>
